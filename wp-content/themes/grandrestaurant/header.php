...
?><!DOCTYPE html>
<html <?php language_attributes(); ?> <?php if (isset($pp_homepage_style) && !empty($pp_homepage_style)) {
    echo 'data-style="' . esc_attr($pp_homepage_style) . '"';
...
<input type="hidden" id="pp_enable_right_click" name="pp_enable_right_click"
       value="<?php echo esc_attr($tg_enable_right_click); ?>"/>
<input type="hidden" id="pp_enable_dragging" name="pp_enable_dragging"
       value="<?php echo esc_attr($tg_enable_dragging); ?>"/>
<input type="hidden" id="pp_image_path" name="pp_image_path"
       value="<?php echo get_template_directory_uri(); ?>/images/"/>
...
<input type="hidden" id="pp_ajax_search" name="pp_ajax_search"
       value="<?php echo esc_attr($tg_menu_search_instant); ?>"/>
...
<input type="hidden" id="pp_page_title_img_blur" name="pp_page_title_img_blur"
       value="<?php echo esc_attr($tg_page_title_img_blur); ?>"/>
<input type="hidden" id="tg_project_filterable_link" name="tg_project_filterable_link"
       value="<?php echo esc_attr($tg_project_filterable_link); ?>"/>
        ...
        <form role="search" method="get" name="searchform" id="searchform" action="<?php echo home_url(); ?>/">
            <div>
                <input type="text" value="<?php the_search_query(); ?>" name="s" id="s" autocomplete="off"
                       placeholder="<?php _e('Search...', THEMEDOMAIN); ?>"/>
                <button>
        ...
        if (!empty($tg_retina_logo)) {
            ...
            <div id="logo_normal" class="logo_container">
                <div class="logo_align">
                    <a id="custom_logo"
                       class="logo_wrapper <?php if (!empty($page_menu_transparent)) { ?>hidden<?php } else { ?>default<?php } ?>"
                       href="<?php echo home_url(); ?>">
                        <?php
                        if ($image_width > 0 && $image_height > 0) {
                            ?>
                            <img src="<?php echo esc_url($tg_retina_logo); ?>"
                        ...
                        <?php
                            ...
                            ?>
                            <img src="<?php echo esc_url($tg_retina_logo); ?>"
                                 alt="<?php esc_attr(get_bloginfo('name')); ?>" width="154" height="59"/>
                        <?php
                        }
                        ?>
                    </a>
                ...
                <div class="logo_align">
                    <a id="custom_logo_transparent"
                       ...
                       href="<?php echo home_url(); ?>">
                        ...
                        if ($image_width > 0 && $image_height > 0) {
                            ?>
                            <img src="<?php echo esc_url($tg_retina_transparent_logo); ?>"
                                 alt="<?php esc_attr(get_bloginfo('name')); ?>"
                                 width="<?php echo esc_attr($image_width); ?>"
                                 height="<?php echo esc_attr($image_height); ?>"/>
                        <?php
...
<div id="wrapper" <?php if (!empty($page_menu_transparent)) { ?>class="hasbg"<?php } ?>>
    ...
    <form id="login" action="login" method="post" style="display: none">
        <p class="txt-italic"><?php echo __('Be a member to order and receive our promotions') ?></p>
        ...
        <div class="form-action">
            <input class="submit-button" type="submit" value="<?php echo __('Log in', 'sutunam') ?>"
                   name="submit">
        </div>
    ...
    <div id="option_wrapper">
        <div class="inner">
            <div style="text-align:center">
                <a target="_blank"
                   href="http://themeforest.net/item/grand-restaurant-restaurant-cafe-theme/11812117?ref=ThemeGoods&license=regular&open_purchase_for_item_id=11812117&purchasable=source&ref=ThemeGoods"
                   class="button buy">BUY THIS THEME NOW!</a>
                <br/><br/>
                <hr/>
                <h6>THEME DEMOS</h6>

                <p>
                    Grandrestaurant is so powerful theme allow you to easily create your own style of restaurant site.
                    Here are example that can be imported with one click.</p>
                <ul class="demo_list">
                    <li>
                        ...
                        <div class="demo_thumb_hover_wrapper">
                            <div class="demo_thumb_hover_inner">
                                <div class="demo_thumb_desc">
                                    ...
                                    <a href="http://themes.themegoods2.com/grandrestaurant/" target="_blank"
                    ...
                    <li>
                        ...
                        <div class="demo_thumb_hover_wrapper">
                            <div class="demo_thumb_hover_inner">
                                <div class="demo_thumb_desc">
                                    <h6>Asian Cuisine</h6>
                                    <a href="http://themes.themegoods2.com/grandrestaurant2" target="_blank"
                                       class="button white">Launch</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="demo_thumb_hover_wrapper">
                            <div class="demo_thumb_hover_inner">
                                <div class="demo_thumb_desc">
                                    <h6>Elegant</h6>
                                    <a href="http://themes.themegoods2.com/grandrestaurant3" target="_blank"
                                       class="button white">Launch</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="demo_thumb_hover_wrapper">
                            <div class="demo_thumb_hover_inner">
                                <div class="demo_thumb_desc">
                                    <h6>Left Menu</h6>
                                    <a href="http://themes.themegoods2.com/grandrestaurant4" target="_blank"
                                       class="button white">Launch</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="demo_thumb_hover_wrapper">
                            <div class="demo_thumb_hover_inner">
                                <div class="demo_thumb_desc">
                                    ...
                                    <a href="http://themes.themegoods2.com/grandrestaurant5" target="_blank"
                                       class="button white">Launch</a>
                                </div>
                            </div>
                        </div>
